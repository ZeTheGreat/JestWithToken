...
module.exports = {
  ...
  //Este parametro serve para parar o test depois do primeiro erro.
   bail: true,
  ...
  // este é para uma extenção do teste chamada coverage que gera um arquivo depois da compilação
